			...
			<tbody>
				...
				@foreach ($docRepor as $row)
					...
					<tr>
						...
						echo $startTime->format('j F, Y, H:i a');//$row['Entry']['StartTime']; //$startTime/->format('j F, Y, g:i a');
							?>
							<!--<div>
						...
						echo $DATE_START_REAL->format('j F, Y, H:i a');
						?></td>
						<td><?php
						...
						echo $DATE_END_REAL->format('j F, Y, H:i a');
						?></td>
